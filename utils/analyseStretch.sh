...
# GET STRETCH DISTRIBUTION
mscript="addpath('$scriptpath');addpath('$utils');getStretch('$f_timeprogress',$ZE,$NBINS)"
$utils/run_mscript.sh "$mscript" > $dir/StretchDistribution.out
echo "Data written to $dir/StretchDistribution.out"
